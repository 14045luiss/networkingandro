package com.example.globalstore.a11retorit.Model;
...
public class Pembelian {
    ...
    public Pembelian ( String id_pembelian , String id_pembeli , String tanggal_beli , int
            total_harga , String id_tiket ) {
